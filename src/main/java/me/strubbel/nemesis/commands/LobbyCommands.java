...
public class LobbyCommands {
    ...
    @Command(name = "lobby.set", aliases = {"lobby.setspawn", "setlobby"}, usage = "/lobby set", permission="nemesis.lobby.set", inGameOnly=true)
    ...
    public void lobby(CommandArgs args) {
        ...
        } else p.sendMessage(Util.getPrefix() + " §7Es wurde noch keine Lobby festgelegt.");;
    }
}