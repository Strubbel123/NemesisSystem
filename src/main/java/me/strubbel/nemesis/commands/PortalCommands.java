...
import me.strubbel.nemesis.PortalManager;
...
public class PortalCommands {
    ...
    @Command(name = "portal.create", aliases = {"portal.add","p.add","p.create"}, usage = "/portal create <portal name> <target name>", permission="nemesis.portal.manage", inGameOnly=true)
    ...
    @Command(name = "portal.delete", aliases = {"portal.remove","p.delete","p.remove"}, usage = "/portal delete <portal name>", permission="nemesis.portal.manage")
    public void delete(CommandArgs args) {
        portalManager.deletePortal(args.getArgs(0), args.getSender());
    }


    @Command(name = "portal.warp", aliases = {"portal.tp","p.warp","p.tp"} , usage = "/portal warp <target name>", permission="nemesis.portal.warp", inGameOnly=true)
    ...
    @Command(name = "portal.list", aliases = "p.list", usage = "/portal list", permission="nemesis.portal.manage")
    ...
    @Command(name = "portal.info", aliases = "p.info", usage = "/portal info <name>", permission="nemesis.portal.manage")
